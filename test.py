...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.windowlabel = ctk.CTkLabel(self,text="Daniel AI Image Generator", font=ctk.CTkFont(size=30, weight="bold"),padx=50, pady=50,text_color="white")
...
if __name__ == "__main__":
    ...
    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